...
const Card = () => {
  return (
    <div className="flex flex-wrap lg:flex-nowrap justify-center lg:justify-evenly gap-3 lg:gap-5 items-start lg:h-[300px] lg:max-w-[1112px] xl:max-w-[1240px] mx-auto lg:px-7 mb-24">
      <TemplateCard icon={BoxCarIcon} h1="Gratis Ongkir" alt="box-car-icon">
      ...
      <TemplateCard icon={DollarIcon} h1="Garansi Uang Kembali" alt="dollar-icon">
      ...
      <TemplateCard icon={CheckIcon} h1="Keamanan Pembayaran" alt="check-icon">
      ...
      <TemplateCard icon={LockIcon} h1="Keaslian 100% Dijamin" alt="lock-icon">
