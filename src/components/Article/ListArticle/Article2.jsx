const Article2 = (props) => {
  ...
  return (
    <div
      className={`${ index === 1 ? "" : "hidden"} flex flex-col items-center absolute top-[300px] px-3 py-3 ${
        index === 1 ? "right-[350px]" : "left-[350px]"
      }`}
    >
      <h1 className="text-4xl font-extralight mb-3 tracking-widest">
        HOTLIST
      </h1>
      <p className="text-6xl font-semibold font-glitten mb-3 tracking-wide">
        THE SPRING
      </p>
      <p className="text-xl font-light text-center w-[500px] ">July 2023</p>
