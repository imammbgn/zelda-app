const Article2 = (props) => {
  ...
  return (
    <div
      className={`${ index === 1 ? "" : "hidden"} flex flex-col items-center absolute top-8 left-10 lg:top-[150px] xl:top-[170px] px-3 py-3 ${
        index === 1 ? "-right-[80px] lg:-right-[250px]" : "left-[350px]"
      }`}
    >
